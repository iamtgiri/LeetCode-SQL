...
-- The COUNT function counts non-null occurrences, resulting in 0 for subjects not attended by a student.
-- Finally, the results are grouped and ordered as specified.
